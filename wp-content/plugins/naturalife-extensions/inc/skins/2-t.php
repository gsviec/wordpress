<?php
	$skin_data = array(
		"naturalife_overlapped_header" => "1", 
		...
		"naturalife_header_color_skin" => "light",
		"naturalife_header_bg_color" => "",
		
		"naturalife_header_logo_location" => "1",
		"naturalife_header_menu_location" => "2",
		"naturalife_header_icon_location" => "3", 

		"naturalife_sticky_header_logo_location" => "1",
		"naturalife_sticky_header_menu_location" => "2",
		"naturalife_sticky_header_icon_location" => "3", 

		"naturalife_sub_header_top_padding"	=> "80",
		"naturalife_sub_header_bottom_padding" => "40",		
	);
?>